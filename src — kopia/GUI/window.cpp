...
bool Window::ObjectsInit()
{
        ...
        models.push_back(ModelWIP("data\\Castle\\Castle OBJ.obj", glm::vec3(50.0f, -2.0f, 0.0f), glm::vec3(0.1f, 0.1f, 0.1f), glm::vec3(0.0f, 0.0f, 0.0f)));
        for (int i = 0; i < 5; i++)
        {
            objects.push_back(new static_object("data\\cube.obj", glm::vec3(pozx,0.0f, 0.0f), glm::vec3(0.3f, 3.0f, 0.3f), glm::vec3(0.0f, 0.0f, 0.0f)));
            pozx += 3;
        }
